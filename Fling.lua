...
-- ===== УМЕНЬШЕННОЕ МЕНЮ ДЛЯ ТЕЛЕФОНА =====
local MainFrame = Instance.new("Frame")
MainFrame.Parent = ScreenGui
MainFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 25)
MainFrame.Position = UDim2.new(0.1, 0, 0.05, 0)  -- Сдвинуто вверх
MainFrame.Size = UDim2.new(0, 200, 0, 350)  -- МЕНЬШЕ!
...
PlayersScroll.Size = UDim2.new(0.9, 0, 0, 0.38)
...
ReloadBtn.Position = UDim2.new(0.05, 0, 0.72, 0)
...
local function ToggleMenu()
    ...
    if getgenv().IsMenuCollapsed then
        ...
        targetSize = UDim2.new(0, 200, 0, 350)
        targetText = "FLING"
...
-- ===== ОСТАЛЬНАЯ ЛОГИКА (физика, анти-флинг и т.д.) =====
...
updateList()
print("✅ FLING VNMA ЗАПУЩЕН! Меню уменьшено для телефона")
